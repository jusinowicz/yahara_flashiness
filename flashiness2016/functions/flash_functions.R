...
# of lake level and precip. 
#
# The model is a bidirectional LSTM. This way of fitting uses
# 3D arrays of lagged predictor variables. It does not seem
# as effective as the more standard approach. 
##############################################################

fit_predLSTM_3D = function(lake_data_lstm, lagsp ){
	#Store fitted models
