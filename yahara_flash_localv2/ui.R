      ...
      tabItem("Waubesa",
        fluidRow(
          column(width = 3,
            ...
            fluidRow(
            #Upcoming peak in rain
            infoBoxOutput("max_rain3",width=12) ),
            fluidRow(
            #Maximum peak in forecast
            infoBoxOutput("max_peak_wau",width=12)),
            fluidRow(
            #Confidence 
            infoBoxOutput("pred_con_wau",width=12))
          ),

          column(width=9,
             fluidRow(
             # Plot the predicted values with CIs 
             box(width = 12, plotOutput("pred_plot3") )
            )
          )
      ...
      tabItem("Kegonsa",
        fluidRow(
          column(width = 3,
            ...
            fluidRow(
            #Upcoming peak in rain
            infoBoxOutput("max_rain4",width=12) ),
            fluidRow(
            #Maximum peak in forecast
            infoBoxOutput("max_peak_keg",width=12)),
            fluidRow(
            #Confidence 
            infoBoxOutput("pred_con_keg",width=12))
          ),

          column(width=9,
             fluidRow(
             # Plot the predicted values with CIs 
             box(width = 12, plotOutput("pred_plot4") )
            )
          )
